...
import {  FaEdit, FaRegFileImage,  FaRegTimesCircle, FaTrashAlt } from 'react-icons/fa';//fa stand for Font Awesome 5
                                ...
                                {values.groupicon ?
                                    <div className="flex items-center space-x-3  my-5">
                                        ...
                                        <label onClick={() => setFieldValue(`groupicon`, "")}>
                                            <FaTrashAlt color='#E94560' size={"1rem"} />
                                        </label>
                                    </div>
                                    : ""}
                                        ...
                                        (<div className='md:flex md:space-x-10 md:items-center relative flex-wrap' key={index}>
                                            ...
                                            <div className="absolute space-y-6  bottom-2 md:bottom-8 right-0"  >
                                               {/* remove a field from the list*/}
                                                <FaTrashAlt className='transition-all  ease-in-out  hover:-mb-1 hover:-translate-y-px'
