...
import createFlashCard from '../image/createFlashCard.jpeg';
...
const MyFlashCard = () => {
    ...
    return (
        <div className='bg-red-50 w-full h-full md:mt-10  px-5  xl:px-44  my-5'>
            ...
            {data.length
                ...
                : <div className=' relative top-24'>
                    ...
                    <img className="mx-auto object-center w-25 h-25 p-2 rounded-2xl" src={createFlashCard} alt="logo" />
