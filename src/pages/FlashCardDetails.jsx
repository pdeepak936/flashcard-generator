            ...
            {cardData[groupId] ?
                <div className='md:mt-10  px-5  xl:px-44  my-5'>
                    <div className='flex space-x-5'>
                        <div>
                            <Link to={'/card'}><FaArrowLeft className='text-slate-700 inline-block  ' size={'1.5rem'} color='black' /></Link>
                        </div>
                    ...
                    <div className='grid xl:grid-cols-5 md:grid-cols-4 grid-cols-2 space-x-10'>
                         {/* side bar for navigation */}
                        <div className=' bg-white shadow-md p-4 rounded-md md:order-none '>
                            <h5 className='font-medium ...'>Flashcards</h5>
                            <hr className=' border-slate-400' />
                            <div className=' p-2 space-y-4 overflow-hidden cardlink'>
                        ...
                        <div className=' col-span-3 grid justify-center'>
                            ...
                            <div className='flex text-slate-700 cursor-pointer justify-center my-5 space-x-5'>
                              ...
                              {/* onClick function for navigating cards */}
                                <FaAngleLeft className='text-black' size={'1.5rem '} onClick={() => handleCorousel('dec')} />
                                <span className='text-black font-bold'>{cardId + 1}/{cardData[groupId].card.length}</span>
                                <FaAngleRight className='text-black' size={'1.5rem'} onClick={() => handleCorousel('inc')} />
                            </div>
                        </div>
                        <Buttons groupId={groupId} cardData={cardData} cardId={cardId} />
                    </div>
                </div> : ""}
        </>
