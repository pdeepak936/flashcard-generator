...
import cardGroup from '../image/cardGroup.png';
        ...
        <div className="mx-auto w-full mt-10 max-w-sm max-h-sm bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl transition-all ease-in-out duration-300 hover:-translate-y-1">
            ...
            <div className="flex flex-col items-center relative pb-10">
                ...
                {items.groupicon
                    ...
                    :<img className="transition-all object-cover ease-in-out duration-500 hover:-translate-y-1 hover:rounded-md w-24 h-24 mb-3 rounded-rounded-lg ... shadow-lg absolute bg-blue-300 -top-10" src={cardGroup} alt="groupicon" />}
